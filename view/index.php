...
<html lang="en">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="view/images/loading.gif" alt="#" /></div>
      </div>
      <!-- end loader -->
      <!-- header -->
      <header>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="header_information">
                           <ul>
                              <li><img src="view/images/1.png" alt="#"/> 145.street road new York</li>
                              <li><img src="view/images/2.png" alt="#"/> +71  5678954378</li>
                              <li><img src="view/images/3.png" alt="#"/> Demo@hmail.com</li>
                           </ul>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo"> <a href="#"><img src="view/images/logo.png" alt="#"></a> </div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    ...
                                    <option>Any</option>
                                       ...
                                       <option><?=$ville->getCityname();  ?></option>
                                      <?php }?>
                                    </select>
                                 </div>
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <div class="about-box">
                        ...
                        <div class="palne-img-area">
                           <img src="view/images/plane-img.png" alt="images">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="traveling-box">
                     <i><img src="view/icon/travel-icon.png" alt="icon"/></i>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="traveling-box">
                     <i><img src="view/icon/travel-icon2.png" alt="icon"/></i>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="traveling-box">
                     <i><img src="view/icon/travel-icon3.png" alt="icon"/></i>
                     <h3>Bus Tours</h3>
                     <p> going to use a passage of Lorem Ipsum, you need to be </p>
                     <div class="read-more">
                        <a  href="#">Read More</a>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="traveling-box">
                     <i><img src="view/icon/travel-icon4.png" alt="icon"/></i>
                     <h3>Summer Rest</h3>
                     <p> going to use a passage of Lorem Ipsum, you need to be </p>
                     <div class="read-more">
                        <a  href="#">Read More</a>
      ...
      <div class="London">
         ...
         <div class="container-fluid">
            <div class="London-img">
               <figure><img src="view/images/London.jpg" alt="img"/></figure>
            </div>
         </div>
      </div>
      <!-- end London -->
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                           <img class="img-responsive" src="view/images/2.jpg" alt="#" />
                           <h3>New York</h3>
                           <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in soe suffk even slightly believable. If y be sure there</p>
                        </div>
                        <div class="item">
                           <img class="img-responsive" src="view/images/3.jpg" alt="#" />
                           <h3>London</h3>
                           <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in soe suffk even slightly believable. If y be sure there</p>
                        </div>
                        <div class="item">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="blog-box">
                     <figure><img src="view/images/blog-image0.jpg" alt="#"/>
               ...
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="blog-box">
                     <figure><img src="view/images/blog-image.jpg" alt="#"/>
               ...
               <div class="row pdn-top-30">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <ul class="location_icon">
                        <li> <a href="#"><img src="view/icon/facebook.png"></a></li>
                        <li> <a href="#"><img src="view/icon/Twitter.png"></a></li>
                        <li> <a href="#"><img src="view/icon/linkedin.png"></a></li>
                        <li> <a href="#"><img src="view/icon/instagram.png"></a></li>
                     </ul>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                     <div class="Follow">
